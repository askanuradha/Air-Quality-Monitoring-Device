...
(library Library_1
	...
	(patternDef "GB1600032" (originalName "GB1600032")
		...
		(layerContents (layerNumRef 28)
			(line (pt -0.66 2.5) (pt -0.66 2.5) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(arc (pt -0.66, 0) (radius 2.5) (startAngle 90.0) (sweepAngle 180.0) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt -0.66 -2.5) (pt 5.54 -2.5) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 5.54 -2.5) (pt 5.54 -2.5) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 5.54, 0) (radius 2.5) (startAngle 270) (sweepAngle 180.0) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 5.54 2.5) (pt -0.66 2.5) (width 0.1))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "GB1600032" (originalName "GB1600032") (compHeader (numPins 2) (numParts 1) (refDesPrefix Y)
		...
		(attr "Datasheet Link" "https://www.diodes.com/assets/Datasheets/GB_GG.pdf")
		(attr "Height" "3.5 mm")
	)
